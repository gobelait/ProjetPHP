...
class ProduitDAO
{
  ...
  // renvoi tout les produits de la catégorie de la base de données
  ...
  // renvoi tout les produits de la catégorie et du sexe de la base de données
  ...
  // renvoi tout les produits de la base de données
